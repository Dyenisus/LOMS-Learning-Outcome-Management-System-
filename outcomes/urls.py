...
urlpatterns = [
    ...
    path("program/<int:program_id>/po/create/", program_outcome_create, name="program_outcome_create"),
    ...
    path("course/<int:course_id>/lo/create/", learning_outcome_create, name="learning_outcome_create"),
